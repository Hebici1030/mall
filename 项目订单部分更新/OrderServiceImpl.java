...
//        productMapper.selectByPrimaryKey( );
    ...
    public ResponseVo<OrderVo> detail(Integer uid, Long orderNo) {
        ...
        if(order==null||!order.getUserId().equals(uid)){
            return ResponseVo.error(ResponseEmnu.ORDER_NOT_EXIST);
        }
        Set<Order> orderSet = new HashSet<>();
        orderSet.add(order);
        List<OrderItme> orderItmeList = orderItmeMapper.selectByOrderNoSet(orderSet);
    ...
    public ResponseVo cancel(Integer uid, Long orderNo) {
        ...
        if(!order.getStatus().equals(OrderStatusEnum.NO_PAY.getCode())){
            return ResponseVo.error(ResponseEmnu.ORDER_STATUS_ERROR);
        }
